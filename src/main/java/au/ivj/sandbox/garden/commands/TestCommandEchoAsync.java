 ...
 */
@Component(value = "command.test_echo_async")
@Scope("prototype")
public class TestCommandEchoAsync implements Command
{
    private static final Logger LOGGER = Logger.getLogger(TestCommandEchoAsync.class);
